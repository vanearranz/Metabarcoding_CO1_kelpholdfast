...
ASV_f1
# To genererate ASV_f1.out without controls and the bioinformatically combined synthetic samples, we have to run ASV_f1 with the function Edesign.merging (found in the Script 1.Edesign_functions_results.R)
...
sample_data(ASV_f1.out_tmp)$SFEP <- Design_long_format$SFEP
...
ASV_f1.out_tmp_R4000_PA_richness<-cbind(ASV_f1.out_tmp_R4000_PA_richness, Design_long_format)
